...
/**
* Interface for iterators of pseudorandom numbers drawn from a Lévy distribution.
*/
...
* // ...
*/
declare function iterator( mu: number, c: number, options?: Options ): Iterator<number>;
