...
tape( 'the function throws an error if scale parameter `c` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator for generating pseudorandom numbers from a Lévy distribution', function test( t ) {
	var rand;
	var it;
	var i;
